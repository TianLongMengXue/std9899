...
0000000000000358 <.note.gnu.build-id>:
 ...
 367:	00 b3 4b a9 15 f3    	add    %dh,-0xcea56b5(%rbx)
 36d:	f9                   	stc    
 36e:	4b                   	rex.WXB
 36f:	45                   	rex.RB
 370:	4e ea                	rex.WRX (bad) 
 372:	bc b1 6a 32 9e       	mov    $0x9e326ab1,%esp
 377:	6a 31                	pushq  $0x31
 379:	e4 93                	in     $0x93,%al
 37b:	2e                   	cs
...
0000000000002000 <_IO_stdin_used>:
    ...
    2004:	74 68                	je     206e <__GNU_EH_FRAME_HDR+0x4a>
    2006:	69 73 20 69 73 20 61 	imul   $0x61207369,0x20(%rbx),%esi
    200d:	20 74 65 73          	and    %dh,0x73(%rbp,%riz,2)
    2011:	74 20                	je     2033 <__GNU_EH_FRAME_HDR+0xf>
    2013:	70 72                	jo     2087 <__GNU_EH_FRAME_HDR+0x63>
    2015:	6f                   	outsl  %ds:(%rsi),(%dx)
    2016:	67 72 61             	addr32 jb 207a <__GNU_EH_FRAME_HDR+0x56>
    2019:	6d                   	insl   (%dx),%es:(%rdi)
    201a:	6d                   	insl   (%dx),%es:(%rdi)
    201b:	69 6e 67 21 21 21 00 	imul   $0x212121,0x67(%rsi),%ebp
...
0000000000002024 <__GNU_EH_FRAME_HDR>:
    ...
    2031:	ef                   	out    %eax,(%dx)
    2032:	ff                   	(bad)  
    2033:	ff 74 00 00          	pushq  0x0(%rax,%rax,1)
    2037:	00 1c f0             	add    %bl,(%rax,%rsi,8)
    203a:	ff                   	(bad)  
    203b:	ff 9c 00 00 00 2c f0 	lcall  *-0xfd40000(%rax,%rax,1)
    2042:	ff                   	(bad)  
    2043:	ff b4 00 00 00 3c f0 	pushq  -0xfc40000(%rax,%rax,1)
    204a:	ff                   	(bad)  
    204b:	ff 5c 00 00          	lcall  *0x0(%rax,%rax,1)
    204f:	00 25 f1 ff ff cc    	add    %ah,-0x3300000f(%rip)        # ffffffffcd002046 <_end+0xffffffffccffe02e>
    2055:	00 00                	add    %al,(%rax)
    2057:	00 4c f1 ff          	add    %cl,-0x1(%rcx,%rsi,8)
    205b:	ff                   	(bad)  
    205c:	ec                   	in     (%dx),%al
    205d:	00 00                	add    %al,(%rax)
    205f:	00 bc f1 ff ff 34 01 	add    %bh,0x134ffff(%rcx,%rsi,8)
	...
...
0000000000002068 <__FRAME_END__-0x104>:
    ...
    20dc:	74 00                	je     20de <__GNU_EH_FRAME_HDR+0xba>
    20de:	00 00                	add    %al,(%rax)
    20e0:	70 ef                	jo     20d1 <__GNU_EH_FRAME_HDR+0xad>
    20e2:	ff                   	(bad)  
